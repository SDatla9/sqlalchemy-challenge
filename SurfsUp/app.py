...
#reflect data base into a new model
Base = automap_base()
#reflect the tables
...
#Convert the query results into a dictionary using 'date' as key and 'prcp' as value.
#return the json format of your dictionary
...
#create  a list of  dict with 'date' and 'prcp' as the keys and  values
 rain_totals = []
    for result in rain:
        row = {}
        row["date"] = rain[0]
